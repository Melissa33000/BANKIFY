...
<html>
  <head>
    <title> Ajout d'une sortie </title>
      ...
      <form method="POST" actions="" onsubmit="return verif()">
        <?php
          if (!empty($_POST)){
            ...
            $SQLQuery = 'CALL proc_addSortie(:nom, :montant , :date, :infosup , :tiers , :frequence, :idcompte , :idMoyenPaiement, :idCategorie)';
        ...
        <div class="Formulaire">
          <div class="fieldset">
            ...
            <div class="champ" > <input class = "resize" id="nom" type="text"  name="nom" placeholder="Nom de l'opération .."> </div>
          </div>
            <div class="ligneChamp">
    ...
    $(document).ready(function(){
      ...
      function verif(){
        ...
        if (!estRemplie(ttNomOp)){
          alert("Un nom d'opération est nécessaire pour continuer l'ajout d'une sortie !");
          ttNomOp.focus();
          return false;
        }
